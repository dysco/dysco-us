#ifndef BESS_DRIVERS_PMD2_H_
#define BESS_DRIVERS_PMD2_H_
 ...
 */
class PMDPort2 final : public Port {
 public:
  PMDPort2()
      : Port(),
   ...
   */
  CommandResponse Init(const bess::pb::PMDPort2Arg &arg);
